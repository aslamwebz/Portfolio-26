    ...
    public function run(): void
    {
        $projects = [
            [
                ...
                'technologies' => json_encode(['TypeScript', 'Bun', 'Capacitor', 'Tailwind CSS', 'Vite']),
                'category' => 'Fullstack',
                'sort_order' => 1,
                'is_featured' => true,
                'created_at' => now(),
            ...
            [
                ...
                'technologies' => json_encode(['TypeScript', 'Bun', 'Tailwind CSS', 'Shadcn/UI']),
                'category' => 'UI/UX',
                'sort_order' => 2,
                'is_featured' => true,
                'created_at' => now(),
            ...
            [
                ...
                'technologies' => json_encode(['Vue', 'TypeScript', 'Shadcn Vue', 'CSS']),
                'category' => 'Enterprise',
                'sort_order' => 3,
                'is_featured' => false,
                'created_at' => now(),
